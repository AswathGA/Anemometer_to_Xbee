...
Error Catching: Serial read/write operations are wrapped in try...except blocks. If communication with a single sensor fails, the script logs the error and continues to the next iteration rather than crashing completely.
